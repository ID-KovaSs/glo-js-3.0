...
(function () {
  function r(e, n, t) {
    ...
    window.addEventListener('DOMContentLoaded', function () {
      ...
      var headerSlider = require('../parts/headerSlider.js');
      var popup = require('../parts/popup.js');
      var addBlocks = require('../parts/addBlocks.js');
      var portfolioTabs = require('../parts/portfolioTabs.js');
      var calc = require('../parts/calc.js');
      var replaceImg = require('../parts/replaceImg.js');
      ...
      var checkRus = require('../parts/checkRus.js');
    ...
    function accordion() {
      ...
      function removeActive() {
        for (var i = 0; i < accorBlock.length; i++) {
    ...
    function addBlocks() {
      var blocksBtn = document.getElementById('addBlocksBtn'),
    ...
    function portfolioTabs() {
      var portfBlocks = document.querySelectorAll('.portfolio-block'),
      ...
      function showBlock(e) {
        ...
        for (var i = 0; i < portfBlocks.length; i++) {
    ...
    function replaceImg() {
      var sizeWrapper = document.querySelector('.sizes-wrapper'),
          ...
          eventTarget = void 0,
          replaceTarget = void 0,
          secondTarget = void 0,
          sizesBlockNum = void 0;
